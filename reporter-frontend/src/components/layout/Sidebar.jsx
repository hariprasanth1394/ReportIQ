  ...
  return (
    <div className="w-[220px] h-screen bg-gradient-to-b from-blue-600 to-blue-700 flex flex-col flex-shrink-0 shadow-xl">
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center gap-3 px-3 py-3 bg-white/10 rounded-2xl backdrop-blur-sm mb-2">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-2.5 rounded-2xl text-blue-100 hover:bg-red-500/20 hover:text-white transition-all duration-200"
        >
